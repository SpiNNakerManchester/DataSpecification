""" Used to generate memory images from a set of instructions.
    ...
    :py:class:`data_allocation.data_specification_generator.DataSpecificationGenerator`\
    ...
    :py:class:`data_allocation.data_specification_executor.DataSpecificationExecutor`\
    class.
"""