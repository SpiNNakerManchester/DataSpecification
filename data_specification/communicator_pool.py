...
class CommunicatorsPool(object):
    ...
    def process_work(awake, packets_queue, x, y, p, iptag,future_id, report_flag, queue_from_spec, semaphore):
        ...
        with semaphore:
            ...
            ds_chip_y=y
            #ds_port=1
            header = SDPHeader(flags=SDPFlag.REPLY_NOT_EXPECTED, destination_cpu=ds_p, destination_chip_x=ds_chip_x, destination_chip_y=ds_chip_y, destination_port=1)
            #time.sleep(1)
