...
class DataType(Enum):
    ...
    U88 = (8, 2,
           ...
           decimal.Decimal(256),
           "H", "8.8 unsigned fixed point number")
    U1616 = (9, 4,
             decimal.Decimal(0),
             decimal.Decimal(65535.9999847),
             decimal.Decimal(65536),
             "I", "16.16 unsigned fixed point number")
    U3232 = (10, 8,
             decimal.Decimal(0),
             decimal.Decimal(4294967295.99999999976716935634613037109375),
             decimal.Decimal(4294967296),
             "Q", "32.32 unsigned fixed point number") #rounding problem for max
    S87 = (11, 2,
           decimal.Decimal(-256),
           decimal.Decimal(255.9921875),
           decimal.Decimal(128),
           "h", "8.7 signed fixed point number")
    S1615 = (12, 4,
             decimal.Decimal(-32768),
             decimal.Decimal(32767.9999847),
             decimal.Decimal(32768),
             "i", "16.15 signed fixed point number")
    S3231 = (13, 8,
             decimal.Decimal(-4294967296),
             decimal.Decimal(4294967295.9999999995343387126922607421875),
             decimal.Decimal(2147483648),
             "q", "32.31 signed fixed point number") #rounding problem for max
    U08 = (16, 1,
           decimal.Decimal(0),
           decimal.Decimal(0.99609375),
           decimal.Decimal(256),
           "B", "0.8 unsigned fixed point number")
    U016 = (17, 2,
            decimal.Decimal(0),
            decimal.Decimal(0.999984741211),
            decimal.Decimal(65536),
            "H", "0.16 unsigned fixed point number")
    U032 = (18, 4,
            decimal.Decimal(0),
            decimal.Decimal(0.99999999976716935634613037109375),
            decimal.Decimal(4294967296),
            "I", "0.32 unsigned fixed point number")
    U064 = (19, 8,
            decimal.Decimal(0),
            decimal.Decimal(
                0.9999999999999999999457898913757247782996273599565029),
            decimal.Decimal(18446744073709551616),
            "Q", "0.64 unsigned fixed point number") #rounding problem for max
    S07 = (20, 1,
           decimal.Decimal(-1),
           decimal.Decimal(0.9921875),
           decimal.Decimal(128),
           "b", "0.7 signed fixed point number")
    S015 = (21, 2,
            decimal.Decimal(-1),
            decimal.Decimal(0.999969482421875),
            decimal.Decimal(32768), "h", "0.15 signed fixed point number")
    S031 = (22, 4,
            decimal.Decimal(-1),
            decimal.Decimal(0.99999999976716935634613037109375),
            decimal.Decimal(2147483648),
            "i", "0.32 signed fixed point number")
    S063 = (23, 8,
            decimal.Decimal(-1),
            decimal.Decimal(
                0.9999999999999999998915797827514495565992547199130058),
            decimal.Decimal(9223372036854775808),
            "q", "0.63 signed fixed point number") #rounding problem for max

    def __new__(cls, value, size, min_val, max_val, scale, struct_encoding, doc=""):
    ...
    def __init__(self, value, size, min_val, max_val, scale, struct_encoding, doc=""):
        self._value_ = value
        self.__doc__ = doc
        self.size = size
        self.min = min_val
