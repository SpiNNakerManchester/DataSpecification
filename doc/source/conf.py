...
htmlhelp_basename = 'DataSpecificationdoc'
...
latex_documents = [
  ('index', 'DataSpecification.tex', u'DataSpecification Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'DataSpecification', u'DataSpecification Documentation',
     [u''], 1)
]
