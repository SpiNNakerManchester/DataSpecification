...
class TestDataSpecGeneration(unittest.TestCase):
    ...
    def test_new_data_spec_generator(self):
        ...
        self.assertEqual(self.dsg.mem_slots, constants.MAX_MEM_REGIONS * [0])
    ...
    def test_reserve_memory_region(self):
        ...
        self.assertEqual(self.dsg.mem_slots[1], [0x111, None, False])
        # Memory region 2 DSG data wrong
        self.assertEqual(self.dsg.mem_slots[2], [0x1122, None, False])
        # Memory region 3 DSG data wrong
        self.assertEqual(self.dsg.mem_slots[3], [0x1122, None, True])
        # FREE wrong command word
        self.assertEqual(self.dsg.mem_slots[4], [0x3344, "test", False])
    ...
    def test_free_memory_region(self):
        ...
        with self.assertRaises(NotAllocatedException):
            self.dsg.free_memory_region(1)
        self.assertEqual(self.dsg.mem_slots[1], 0)
